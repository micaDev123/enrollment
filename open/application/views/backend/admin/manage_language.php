           	...
           	<div class="panel-heading">
					 <?php echo get_phrase('Manage Language'); ?>
						...
						<?php endif;?>
						 ...
						 <a href="<?php echo base_url(); ?>admin/manage_language"><button type="button" class="btn btn-default btn-xs">
						...
						<button type="button" class="btn btn-default btn-xs"><i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('add_language');?>
						</button></a>
						
						<a href="javascript:;" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/add_phrase/');">
						<button type="button" class="btn btn-default btn-xs"><i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('add_string');?>
						</button></a>
			</div>
