...
class Admin extends CI_Controller { 
    ...
    function __construct() {
        parent::__construct();
                ...
                $this->load->model('StudentEnrollment_model');              // Load Apllication Model Here
    ...
    function get_class_section_subject($section_id){
    ...
    function section_subject_edit($section_id, $class_routine_id){
    ...
    function get_class_section($section_id){
    ...
    function studentEnrollment ($param1 = null, $param2 = null, $param3 = null){

        if($param1 == 'create'){
            $this->StudentEnrollment_model->createexamQuestion();
            $this->session->set_flashdata('flash_message', get_phrase('Data saved successfully'));
            redirect(base_url(). 'admin/studentEnrollment', 'refresh');
        } 
        ...
        $page_data['page_name']     = 'studentEnrollment';
        $page_data['page_title']    = get_phrase('Enrollment Form');
        $this->load->view('backend/index', $page_data);
    }
