	...
	<a href="<?php echo base_url();?>admin/section/"><button type="button" class="btn btn-info btn-circle btn-xs"><i class="fa fa-plus"></i></button></a>
						...
						<label class="col-md-12" for="example-text"><?php echo get_phrase('section');?></label>
							<div class="col-sm-12">
								<select name="section_id" class="form-control select2">
									...
									<?php $section =  $this->db->get('section')->result_array();
									foreach($section as $key => $section):?>
									<option value="<?php echo $section['section _id'];?>"><?php echo $section['section_name'];?></option>
									<?php endforeach;?>
								</select>
							<a href="<?php echo base_url();?>admin/section/"><button type="button" class="btn btn-info btn-circle btn-xs"><i class="fa fa-plus"></i></button></a>
							</div>
			...
			<!-- <div class="form-group">
				...
				<div class="form-group">
					...
					<div class="form-group">
                 	<label class="col-md-9" for="example-text"><?php echo get_phrase('date_of_enrollment');?></label>
                    <div class="col-sm-12">
							<input type="date" value="2011-08-19" id="example-date-input" class="form-control datepicker" name="date_of_enrollment">
...
<script type="text/javascript">
	...
	function get_class_sections(section_id) {

    	$.ajax({
            url: '<?php echo base_url();?>admin/get_class_section/' + section_id ,
